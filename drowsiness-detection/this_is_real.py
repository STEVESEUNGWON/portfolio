...
from ultralytics import YOLO  # YOLOv5 객체 검출을 위한 Ultralytics YOLO 라이브러리
            ...
            for subject in subjects:
                ...
                if ear < thresh:
                    ...
                    if flag >= 4:  # 졸음이 연속으로 감지된 경우
                        ...
                        # 졸음이 감지되면 소리를 재생합니다.
                        pygame.mixer.music.load(r'C:\ITWILL\final_project\sound1.wav')  # 소리 파일의 경로로 변경
...
def generate_yolo_frames():
    # YOLOv8 모델을 불러옵니다
    yolo_model = YOLO(r"C:\ITWILL\final_project\yolov8\yolov8\runs\detect\train\weights\best.pt")
            ...
            for item in yolo_results:
                ...
                for cls, conf in zip(item.boxes.cls, item.boxes.conf):
                    ...
                    if counter > 6:
                        ...
                        # 졸음이 감지되면 소리를 재생합니다.
                        pygame.mixer.music.load(r'C:\ITWILL\final_project\alarm.wav')  # 소리 파일의 경로로 변경
                        pygame.mixer.music.play()
